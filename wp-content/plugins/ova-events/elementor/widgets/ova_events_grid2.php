...
class ova_events_grid2 extends Widget_Base {


	public function get_name() {		
		return 'ova_events_grid2';
	}

	public function get_title() {
		return __( 'Events Grid 2', 'ovaev' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' => 'one_column',
					'options' => [
						'one_column' => __('One Columns', 'ovaev'),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .event-grid3 .item .desc .date-event,.ovaev-content.content-grid .date-event .date' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .event-grid3 .item .desc .date-event' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .event-grid3 .item .desc .event_post .event_title a' => 'color: {{VALUE}}',
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .event-grid3 .item .desc .event_post .event_title a:hover' => 'color: {{VALUE}} !important',
			...
			[
				...
				'selector' => '{{WRAPPER}} .event-grid3 .item .desc .event_post .event_title a',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .event-grid3 .item .desc .event_post .time-event svg ' => 'color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}  .event-grid3 .item .desc .event_post .time-event span' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		$template = apply_filters( 'el_elementor_ova_event', 'elementor/ovaev_events_grid.php' );
