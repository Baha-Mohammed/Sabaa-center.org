...
class ova_events_cat extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'version',
				[
					'label' => __('Version','ovaev'),
					'type' => Controls_Manager::SELECT,
					'default' => 'version_1',
					'options' => [
						'version_1' => __('List', 'ovaev'),
						'version_2' => __('Grid', 'ovaev'),
						'version_3' => __('List2', 'ovaev'),
 					]
				]
			);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ovaev-event-element.version_3 .item .title a:hover' => 'color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ovaev-event-element.version_3 svg ' => 'color: {{VALUE}}',
	...
	protected function render() {
		...
		$template = apply_filters( 'el_elementor_ova_event', 'elementor/ovaev_events_cat.php' );
