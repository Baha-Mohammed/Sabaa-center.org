...
class ova_events_pro extends Widget_Base {


	public function get_name() {		
		return 'ova_events_pro';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ovaev-content.content-grid .item-pro .date-event .date-month' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ovaev-content.content-grid .item-pro .date-event .date-month .month' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ovaev-content.content-grid .item-pro .desc .event_post_pro .time-event-pro svg' => 'color: {{VALUE}}',
	...
	protected function render() {
		...
		$template = apply_filters( 'el_elementor_ova_event', 'elementor/ovaev_events_pro.php' );
